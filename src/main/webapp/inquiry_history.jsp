...
<c:url var="cssUrl" value="../my-contact-app/css/style.css" />
			...
			<c:when test="${not empty inquiries}">
				<c:forEach var="inquiry" items="${inquiries}" varStatus="status">
					<div class="inquiry-item">
						...
						<p><strong>添付ファイル</strong>
							<c:choose>
								<c:when test="${not empty inquiry.attachmentFileName}">
									<a href="../uploads/${inquiry.attachmentFileName}" target="_blank">
						...
						<form action="${historyUrl}" method="post" style="display:inline">
